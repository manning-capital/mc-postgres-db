...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=False,
            comment="The name of the sentiment type",
        ),
        sa.Column(
            "description",
            sa.String(length=1000),
            nullable=True,
            comment="The description of the sentiment type",
        ),
        sa.Column(
            "is_active",
            sa.Boolean(),
            nullable=False,
            comment="Whether the sentiment type is active",
        ),
        sa.Column(
            "created_at",
            sa.DateTime(),
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            sa.String(length=1000),
            nullable=True,
            comment="The URL of the provider",
        ),
    )
    op.add_column(
        "provider",
        sa.Column(
            ...
            sa.String(length=1000),
            nullable=True,
            comment="The URL of the provider's image",
        ),
    )
    op.alter_column(
        "provider",
