...
Revision ID: d6667fc8ea42
Revises: 4e3486fc8e3b
Create Date: 2025-12-20 10:50:17.844195
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Boolean(),
            nullable=False,
            comment="Whether the transaction status type is active",
        ),
        sa.Column(
            "created_at",
            sa.DateTime(),
        ...
        sa.PrimaryKeyConstraint("id", name=op.f("transaction_status_type_pkey")),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["transaction_status_type_id"],
            ["transaction_status_type.id"],
        ),
        sa.PrimaryKeyConstraint(
            "timestamp",
            "portfolio_transaction_id",
            name=op.f("transaction_status_pkey"),
        ),
...
def downgrade() -> None:
    ...
    op.drop_table("transaction_status_type")
